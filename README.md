...
“Düşük güvenli yüzeyler” otomatik confidence artan, ardından ad ve stabil ID sırasıyla eksiksiz bir keyboard-accessible inceleme listesi sunar. Bir satır terrain değiştirmez; yalnız o yüzeyi tek seçim ve inspector hedefi yapar, haritada işaretler ve mevcut viewBox kamerasının dışındaysa zoom’u koruyarak merkeze getirir. “Seçileni Sınıflandır” masaüstü ve mobilde Arazi Analizi sekmesini açar, dört terrain kontrolünü odaklayıp kısa süre vurgular; çoklu seçimin tamamı tek undo komutu olarak değişir.

Gelişmiş boundary işlemi “Seçimi Sınır Halkası Olarak Analiz Et” adıyla ayrı tutulur. Kullanıcı dolu hedef alanı değil, bitişik yüzeylerden oluşan tek bağlı halkayı seçer. Deterministik flood fill bağlantısız bileşenleri, ikiden az seçili komşusu olan uçları, dış alan bırakmayan tam seçimi ve algılanabilir iç alanı olmayan dolu seçimi ayrı Türkçe nedenlerle reddeder; iç alan hiçbir zaman tahmin edilmez.
