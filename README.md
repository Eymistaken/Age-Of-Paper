...
Komşuluk metadata’sı eksikse yalnızca import sırasında SVG `viewBox` koordinatlarında deterministik bounding-box yakınlığı kullanılır. Bu sonuç zoom, viewport ve cihaz genişliğinden etkilenmez fakat yaklaşık olduğu için lobide uyarı gösterilir. Yeni haritalarda açık metadata kullanılmalıdır.
